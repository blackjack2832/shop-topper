...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    covertedHit: function covertedHit() {
      if (this.hit == true) return 1;else return 0;
    },
    convertedIsActive: function convertedIsActive() {
      if (this.is_active == true) return 1;else return 0;
    }
  },
  methods: {
    ...
    store: function store() {
      ...
      axios.post('/api/product', data).then(function (res) {
...
var render = function () {
  ...
  return _c("div", { staticClass: "w-50" }, [
    ...
    _vm._v(" "),
    _c("div", { ref: "dropzone", staticClass: "p-5 bg-gray" }, [
      _vm._v("Добавьте изображения"),
    ]),
    _vm._v(" "),
    _c(
      "button",
